...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/rote/css'));
});
  ...
  return gulp.src('dist/index.js')
    .pipe(rollup({
      plugins: [
        commonjs({
          namedExports: {
            'node_modules/react/index.js': [ 'Component', 'useState', 'useReducer', 'useEffect', 'useRef' ],
    ...
    .pipe(gulp.dest('./urbit/app/rote/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/rote/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/rote/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/rote/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/rote/js/'));
});
...
gulp.task('watch', gulp.series('default', function() {
  ...
  gulp.watch('src/**/*.js', gulp.series('js-bundle-dev', 'urbit-copy'));
